...
options = [['Berlin','Madrid','Paris','Rome','Paris'],
           ['Venus','Mars','Jupiter','Saturn','Mars'],
           ['Elephant','Blue Whale','Giraffe','Gorilla','Gorilla'],
           ['William Shakespeare','Jane austen','Charles Cickens','Emily bronte','William Shakespeare'],
           ['O2','H20','CO','C','H20']]
